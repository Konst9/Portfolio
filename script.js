...
function selectImage(index) {
  ...
  document.querySelectorAll(".selectImg div").forEach((item, i) => {
    if (i === selectedIndex) {
...
function drawImages() {
  const images = document.querySelectorAll(".selectImg img");
  data.forEach((item, i) => {
...
function init() {
  loadIamges();
  document.querySelector(".selectImg").addEventListener("click", onThumbClick);
